...
def test_tcv_delta_no_termination_survival_manifest_has_36_variants() -> None:
    manifest = build_manifest(
        "broad",
    ...
    assert {variant["reward"]["boundary_missing_weight"] for variant in variants} == {40.0, 60.0, 100.0}
    assert {variant["reward"]["ip_weight"] for variant in variants} == {0.6, 1.2, 1.8}
    assert {variant["reward"]["current_weight"] for variant in variants} == {0.75, 1.5, 3.0, 6.0}
    assert {variant["reward"]["derivative_weight"] for variant in variants} == {0.1875, 0.375, 0.75, 1.5}
    assert {variant["reward"]["actuator_saturation_weight"] for variant in variants} == {0.1875, 0.375, 0.75, 1.5}
