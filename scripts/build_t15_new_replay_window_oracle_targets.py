...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--machine-config", default="../tokamak-sim/runs/t15md_trim50_plain_gpu1e6_top5_replay/T15MD_trim50_plain_gpu1e6_replay.toml")
    ...
    parser.add_argument("--train-shots", nargs="+", default=["3855", "3863", "3856", "3854"])
    parser.add_argument("--holdout-shots", nargs="+", default=["3859"])
