...
def main(argv: list[str] | None = None) -> int:
    ...
    cfg["name"] = f"t15_new_replay_window_0p1s_tcvjdot_{args.reward_preset}_oracle_8gpu_10m"
...
def _validate(cfg: dict[str, object], *, reward_preset: str) -> None:
    checks = {
        ...
        "observation.actor_kind": cfg["observation"]["actor_kind"] == "controller_state_v5",
