...
def _deployment_simulator_from_env(env: TokamakMagneticControlEnv, *, device: str) -> BatchedGpuTokamakSimulator:
    return BatchedGpuTokamakSimulator(
        ...
        boundary_legacy_precision_index2=env.cfg.boundary_legacy_precision_index2,
        boundary_smooth_selected_level=env.cfg.boundary_smooth_selected_level,
        boundary_soft_level_selection=env.cfg.boundary_soft_level_selection,
        boundary_soft_level_candidates=env.cfg.boundary_soft_level_candidates,
        boundary_soft_level_temperature=env.cfg.boundary_soft_level_temperature,
        boundary_soft_level_radius_weight=env.cfg.boundary_soft_level_radius_weight,
        boundary_soft_level_missing_penalty=env.cfg.boundary_soft_level_missing_penalty,
        boundary_soft_level_roughness_penalty=env.cfg.boundary_soft_level_roughness_penalty,
