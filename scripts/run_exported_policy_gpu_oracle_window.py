...
def _deployment_simulator_from_env(env: TokamakMagneticControlEnv, *, device: str) -> BatchedGpuTokamakSimulator:
    return BatchedGpuTokamakSimulator(
        ...
        boundary_soft_level_selection=env.config.sim.boundary_soft_level_selection,
        boundary_soft_level_candidates=env.config.sim.boundary_soft_level_candidates,
        boundary_soft_level_temperature=env.config.sim.boundary_soft_level_temperature,
        boundary_soft_level_radius_weight=env.config.sim.boundary_soft_level_radius_weight,
        boundary_soft_level_missing_penalty=env.config.sim.boundary_soft_level_missing_penalty,
        boundary_soft_level_roughness_penalty=env.config.sim.boundary_soft_level_roughness_penalty,
