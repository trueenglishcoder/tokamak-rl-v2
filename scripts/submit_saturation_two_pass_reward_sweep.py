...
try:
    from scripts.build_reward_sweep_manifest import PROFILE_SATURATION
    ...
    from build_reward_sweep_manifest import PROFILE_SATURATION
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--pass1-job",
        type=Path,
        default=Path("jobs/sweep_t15_csv_segmented_profile_rewards_12gpu_saturation_pass1.sbatch"),
    )
    parser.add_argument(
        "--pass1-aggregate-job",
        type=Path,
    ...
    parser.add_argument(
        "--pass2-job",
        type=Path,
        default=Path("jobs/sweep_t15_csv_segmented_profile_rewards_12gpu_saturation_pass2.sbatch"),
    )
    parser.add_argument(
        "--final-aggregate-job",
        type=Path,
