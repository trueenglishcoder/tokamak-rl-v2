...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build balanced target-only T15 proxy Ip/boundary trajectory windows.")
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("data/processed/t15_proxy_target_balanced_v1"))
    parser.add_argument("--theta-count", type=int, default=32)
    parser.add_argument("--train-parents", type=int, default=96)
    parser.add_argument("--holdout-parents", type=int, default=16)
    ...
    parser.add_argument("--target-train-windows", type=int, default=54400)
    parser.add_argument("--target-holdout-windows", type=int, default=9600)
