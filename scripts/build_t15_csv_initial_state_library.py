...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--experiment-config", default="configs/experiments/t15_new_trim50_plain_gpu1e6_replay_window_0p1s_tcvjdot_mpo_balanced.yaml")
    ap.add_argument("--data-root", default="../tokamak-sim/data/t15_data_new_trim50")
    ap.add_argument("--ip-glob", default="ip/t15md_*_ip.csv")
    ap.add_argument("--coils-dir", default="coils")
    ap.add_argument("--machine-config", default="../tokamak-sim/runs/t15md_trim50_plain_gpu_1e6_setup/T15MD_new_data_trim50_plain_gpu_1e6_3856.toml")
    ap.add_argument("--delimiter", default=";")
    ap.add_argument("--out-npz", default="data/processed/t15_new_trim50_plain_gpu1e6_csv_initial_states.npz")
    ap.add_argument("--out-json", default="data/processed/t15_new_trim50_plain_gpu1e6_csv_initial_states.json")
    ap.add_argument("--out-rejected", default="data/processed/t15_new_trim50_plain_gpu1e6_csv_initial_states_rejected.csv")
