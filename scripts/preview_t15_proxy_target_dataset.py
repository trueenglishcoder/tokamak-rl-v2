...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a small preview of target-only T15 proxy trajectories.")
    ...
    parser.add_argument("--preview-dir", type=Path, default=Path("data/previews/t15_proxy_target_v1_preview"))
    parser.add_argument("--theta-count", type=int, default=32)
    parser.add_argument("--train-parents", type=int, default=2)
    ...
    preview = write_target_preview(
        ...
        title="T15 proxy target-only preview",
    )
    out = {
