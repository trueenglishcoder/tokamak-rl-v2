    ...
    def _reset_from_payload(self, payload: ResetPayload) -> Tensor:
        ...
        if self.config.sim.compute_backend == "gpu":
            self._gpu_sim = BatchedGpuTokamakSimulator(
                ...
                boundary_soft_level_selection=self.config.sim.boundary_soft_level_selection,
                boundary_soft_level_candidates=self.config.sim.boundary_soft_level_candidates,
                boundary_soft_level_temperature=self.config.sim.boundary_soft_level_temperature,
                boundary_soft_level_radius_weight=self.config.sim.boundary_soft_level_radius_weight,
                boundary_soft_level_missing_penalty=self.config.sim.boundary_soft_level_missing_penalty,
                boundary_soft_level_roughness_penalty=self.config.sim.boundary_soft_level_roughness_penalty,
