...
from tokamak_rl_v2.training.shot_bootstrap import ShotBootstrapConfig, run_shot_bootstrap
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        bootstrap_cfg = ShotBootstrapConfig(
        ...
        bootstrap_report = run_shot_bootstrap(trainer, config=cfg, bootstrap=bootstrap_cfg, output_dir=output_dir, wandb_run=wandb_run)
        _write_json(output_dir / "shot_bootstrap_summary.json", bootstrap_report)
        ...
        report = {
            ...
            "no_control": holdout_baseline,
            "shot_bootstrap": bootstrap_report,
...
def _parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Train a T15 policy with fast idealized-shot behavior-cloning bootstrap before MPO.")
    ...
    ap.add_argument("--bootstrap-steps", type=int, default=2000)
    ...
    ap.add_argument("--bootstrap-log-interval", type=int, default=50)
    ...
    ap.add_argument("--wandb-project", default="tokamak-rl-v2-shot-bootstrap")
