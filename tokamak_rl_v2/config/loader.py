...
def _validate_experiment_config(cfg: ExperimentConfig) -> None:
    ...
    if cfg.observation.actor_kind not in {"controller_state_v4", "controller_state_v5", "controller_state_v6", "controller_state_v7_no_step_norm", "controller_state_v8_safety_margin"}:
        raise ValueError("observation.actor_kind must be controller_state_v4, controller_state_v5, controller_state_v6, controller_state_v7_no_step_norm, or controller_state_v8_safety_margin")
    ...
    if training.production_mode:
        ...
        if cfg.reference.ip.kind == "replay_window" and cfg.observation.actor_kind not in {"controller_state_v6", "controller_state_v7_no_step_norm", "controller_state_v8_safety_margin"}:
            raise ValueError("training.production_mode replay_window requires observation.actor_kind=controller_state_v6, controller_state_v7_no_step_norm, or controller_state_v8_safety_margin")
